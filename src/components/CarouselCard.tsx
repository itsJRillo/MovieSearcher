...
const CarouselCard: React.FC<CarouselCardProps> = ({ movie }) => {
    ...
    >
      ...
      <div className="carousel-card-content">
        ...
        <div className="carousel-card-vote-container">
          ...
          <p className="carousel-card-vote-average">{movie.vote_average}</p>
        </div>
      </div>
      {isHovered && (
        <div className="carousel-card-overlay">
          <p className="carousel-card-description">{movie.overview}</p>
        </div>
      )}
    </div>
  );
